-- ============================================
-- SCRIPT IMPORT DATA - LITE COMMERCE (FIXED)
-- ============================================
...
-- ============================================
-- 2. INSERT SUPPLIERS (Province phải đúng với bảng Provinces)
-- ============================================
SET IDENTITY_INSERT Suppliers ON;
INSERT INTO Suppliers (SupplierID, SupplierName, ContactName, Province, Address, Phone, Email)
VALUES (1, N'Apple Việt Nam', N'Nguyễn Văn Minh', N'Thành phố Hồ Chí Minh', N'123 Nguyễn Huệ, Quận 1', N'0901234567', N'contact@apple-vietnam.com');
...
INSERT INTO Suppliers (SupplierID, SupplierName, ContactName, Province, Address, Phone, Email)
VALUES (3, N'ASUS Technology', N'Lê Hoàng Nam', N'Thành phố Hồ Chí Minh', N'789 Điện Biên Phủ, Quận 3', N'0903456789', N'support@asus-vn.com');
...
-- Bàn phím (CategoryID = 1, SupplierID = 4)
...
N'Bàn phím cơ E-DRA EK375 V2 với switch Blue cho cảm giác bấm sắc nét, đèn RGB custom, keycap PBT double-shot chống mài mòn.',
4, 1, N'Chiếc', 1290000, N'Bàn phím/Bàn phím cơ E-DRA EK375 V2 Beta Blue Black/đen.png', 1);

INSERT INTO Products (ProductID, ProductName, ProductDescription, SupplierID, CategoryID, Unit, Price, Photo, IsSelling)
VALUES (2, N'Bàn phím không dây Aula F75 Max Glacier Blue',
N'Bàn phím không dây Aula F75 Max - Kết nối đa chế độ (2.4GHz, Bluetooth, USB-C), pin trâu, switch hot-swap.',
4, 1, N'Chiếc', 1590000, N'Bàn phím/Bàn phím không dây Aula F75 Max Glacier Blue/Glacier blue.png', 1);

-- Điện thoại (CategoryID = 2, SupplierID = 1 hoặc 2)
INSERT INTO Products (ProductID, ProductName, ProductDescription, SupplierID, CategoryID, Unit, Price, Photo, IsSelling)
VALUES (3, N'iPhone 17 Pro Max 256GB Chính hãng',
N'iPhone 17 Pro Max với chip A19 Pro, màn hình Super Retina XDR 6.9 inch, camera 48MP.',
1, 2, N'Chiếc', 39990000, N'Điện thoại/iPhone 17 Pro Max 256GB | Chính hãng/bạc.png', 1);

INSERT INTO Products (ProductID, ProductName, ProductDescription, SupplierID, CategoryID, Unit, Price, Photo, IsSelling)
VALUES (4, N'Samsung Galaxy S26 Ultra 12GB 256GB',
N'Samsung Galaxy S26 Ultra với chip Snapdragon 8 Gen 4, màn hình Dynamic AMOLED 2X 6.8 inch.',
2, 2, N'Chiếc', 32990000, N'Điện thoại/Samsung Galaxy S26 Ultra 12GB 256GB/đen classic.png', 1);

INSERT INTO Products (ProductID, ProductName, ProductDescription, SupplierID, CategoryID, Unit, Price, Photo, IsSelling)
VALUES (5, N'iPhone 15 128GB Chính hãng VN',
N'iPhone 15 với chip A16 Bionic, màn hình Super Retina XDR 6.1 inch, Dynamic Island, USB-C.',
1, 2, N'Chiếc', 19990000, N'Điện thoại/iPhone 15 128GB | Chính hãng VN/đen.png', 1);

-- Laptop (CategoryID = 3, SupplierID = 1 hoặc 3)
INSERT INTO Products (ProductID, ProductName, ProductDescription, SupplierID, CategoryID, Unit, Price, Photo, IsSelling)
VALUES (6, N'Laptop ASUS ROG Strix G16 G614PH-S5101W',
N'Laptop gaming ASUS ROG Strix G16 với Intel Core i9-14900HX, NVIDIA RTX 4060 8GB, RAM 16GB DDR5.',
3, 3, N'Chiếc', 44990000, N'Laptop/Laptop ASUS ROG Strix G16 G614PH-S5101W/xám 1.png', 1);

INSERT INTO Products (ProductID, ProductName, ProductDescription, SupplierID, CategoryID, Unit, Price, Photo, IsSelling)
VALUES (7, N'MacBook Air M4 13 inch 2025 10CPU 8GPU 16GB 256GB',
N'MacBook Air M4 2025 - Chip M4 mới nhất, 10CPU/8GPU, 16GB RAM, 256GB SSD, pin 18 giờ.',
1, 3, N'Chiếc', 32990000, N'Laptop/MacBook Air M4 13 inch 2025 10CPU 8GPU 16GB 256GB | Chính hãng Apple Việt Nam/bạc.png', 1);

INSERT INTO Products (ProductID, ProductName, ProductDescription, SupplierID, CategoryID, Unit, Price, Photo, IsSelling)
VALUES (8, N'MacBook Air M3 15 inch 2024 8CPU 10GPU 16GB 256GB',
N'MacBook Air M3 15 inch - Chip M3, 8CPU/10GPU, 16GB RAM, 256GB SSD, màn hình 15.3 inch.',
1, 3, N'Chiếc', 28990000, N'Laptop/MacBook Air M3 15 inch 2024 8CPU 10GPU 16GB 256GB Sạc 35W | Chính hãng Apple Việt Nam/bạc.png', 1);

-- Màn hình (CategoryID = 4, SupplierID = 3)
INSERT INTO Products (ProductID, ProductName, ProductDescription, SupplierID, CategoryID, Unit, Price, Photo, IsSelling)
VALUES (9, N'Màn hình Gaming ASUS TUF VG27AQ5A 27 inch',
N'Màn hình gaming ASUS TUF Gaming VG27AQ5A - 27 inch, WQHD 2560x1440, IPS, 180Hz, G-Sync compatible.',
3, 4, N'Chiếc', 8990000, N'Màn hình/Màn hình Gaming ASUS TUF VG27AQ5A 27 inch/34 inch - QWHD VA - 180Hz.png', 1);

INSERT INTO Products (ProductID, ProductName, ProductDescription, SupplierID, CategoryID, Unit, Price, Photo, IsSelling)
VALUES (10, N'Màn hình Gaming ASUS ROG Swift OLED PG34WCDM',
N'Màn hình ASUS ROG Swift OLED PG34WCDM - 34 inch UWQHD, OLED, 240Hz, USB-C 90W.',
3, 4, N'Chiếc', 45990000, N'Màn hình/Màn hình Gaming ASUS ROG Swift OLED PG34WCDM/34 inch – UWQHD OLED – 240Hz.png', 1);
...
-- Nhân viên giao hàng
INSERT INTO Employees (EmployeeID, FullName, BirthDate, Address, Phone, Email, Password, Photo, IsWorking, RoleNames)
VALUES (4, N'Lê Thị Mai', '1993-08-25', N'Thành phố Hồ Chí Minh', N'0945678901', N'delivery@myshop.com',
...
INSERT INTO Shippers (ShipperID, ShipperName, Phone) VALUES (1, N'Giao Hàng Nhanh (GHN)', N'1900 1234');
INSERT INTO Shippers (ShipperID, ShipperName, Phone) VALUES (2, N'Viettel Post', N'1900 8095');
INSERT INTO Shippers (ShipperID, ShipperName, Phone) VALUES (3, N'Giao Hàng Tiết Kiệm (GHTK)', N'1900 1235');
SET IDENTITY_INSERT Shippers OFF;
GO

-- ============================================
-- 6. INSERT PRODUCT PHOTOS
-- ============================================
...
VALUES (1, 3, N'Điện thoại/iPhone 17 Pro Max 256GB | Chính hãng/bạc.png', N'iPhone 17 Pro Max - Bạc', 1, 0);
INSERT INTO ProductPhotos (PhotoID, ProductID, Photo, Description, DisplayOrder, IsHidden)
VALUES (2, 3, N'Điện thoại/iPhone 17 Pro Max 256GB | Chính hãng/xanh đậm.png', N'iPhone 17 Pro Max - Xanh đậm', 2, 0);
INSERT INTO ProductPhotos (PhotoID, ProductID, Photo, Description, DisplayOrder, IsHidden)
VALUES (3, 3, N'Điện thoại/iPhone 17 Pro Max 256GB | Chính hãng/cam vũ trụ.png', N'iPhone 17 Pro Max - Cam vũ trụ', 3, 0);
...
VALUES (1, 3, N'Màn hình', N'6.9 inch Super Retina XDR, OLED, ProMotion 120Hz', 1);
INSERT INTO ProductAttributes (AttributeID, ProductID, AttributeName, AttributeValue, DisplayOrder)
...
INSERT INTO Customers (CustomerID, CustomerName, ContactName, Province, Address, Phone, Email, Password, IsLocked)
VALUES (3, N'Lê Hoàng Nam', N'Nam', N'Thành phố Hồ Chí Minh', N'789 Đường DEF, Quận Bình Thạnh', N'0923456789', N'nam@gmail.com', N'4297f44b13955235245b2497399d7a93', 0);
